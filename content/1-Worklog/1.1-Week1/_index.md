...
* Get acquainted with members of First Cloud AI Journey.
* Understand the internship regulations and learning roadmap.
...
* Understand the basic architecture and core AWS services.
...
* Understood the objectives and learning roadmap of First Cloud AI Journey.

* Learned Cloud Computing concepts including:
  * Public Cloud
  * Private Cloud
  * Hybrid Cloud
  * Multi Cloud
...
* Learned AWS account security best practices.

* Successfully configured IAM including:
  * IAM Users
  * User Groups
  * IAM Policies
  * MFA
...
* Became familiar with AWS Management Console and service navigation.

* Understood the purpose of major AWS services:
  * EC2
  * S3
  * VPC
  * IAM
...
* Developed the ability to securely manage AWS resources using IAM instead of the Root Account.

* Completed all introductory labs for Week 1.